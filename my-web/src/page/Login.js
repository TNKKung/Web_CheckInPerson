        ...
        <div class="mt-10 flex-col flex ml-auto mr-auto items-center w-full lg:w-2/3 md:w-3/5">
          <img src={Image} width="200" alt="img" class="mb-5"/>
            <form action="" class="mt-7 flex flex-col lg:w-1/2 w-8/12">
                ...
                <Link to="/" class="text-base text-white text-right font-roboto leading-normal hover:underline">Forget Password ?</Link>
                <Link to="/home" class="bg-blue-500 py-4 text-center px-17 md:px-12 md:py-4 text-white rounded leading-tight text-xl md:text-base font-sans mt-4 mb-20">
                  Login
                </Link>
            </form>
        </div>
